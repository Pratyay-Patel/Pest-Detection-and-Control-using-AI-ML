...
# LABEL_MAPS["pests"] is defined as ["No Pest", "Aphid", "Rust", "Planthopper", "Blight", "Whitefly", "Extra"]
# So if the predicted index is 0, that means "No Pest", and should display "Pest Not Detected".
# Any other index indicates a pest, so we display "Pest Detected".
LABEL_MAPS = {
...
num_crops = len(LABEL_MAPS["crops"])  # keep current number of crops
num_pests = 6                         # match the checkpoint’s number of pest classes
